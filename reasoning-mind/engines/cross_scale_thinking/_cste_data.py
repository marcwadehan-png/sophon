...
包含完整的尺度层级定义、涌现案例、物理常数
"""

from typing import Dict

from ._cste_enums import ScaleLevel, EmergenceType
from ._cste_dataclasses import ScaleInfo, EmergenceExample, PhysicalConstant
...
__all__ = ['SCALE_HIERARCHY', 'EMERGENCE_EXAMPLES', 'FINE_TUNED_CONSTANTS']
